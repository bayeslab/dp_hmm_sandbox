...
class Data_sum(object):
    def __init__(self,Data,k):
        self.alpha=random.gammavariate(1,1)
        self.k=k
        self.Data=Data
        sum_total = 0
        var_total=0
...
class Hyperparameter(object):
    def __init__(self,mu_y,sd_y,k):
        ...
        self.r=random.gammavariate(1,pow(self.sd_y,-2))
        self.beta=1/random.gammavariate(1,1)
        self.omega=random.gammavariate(1,pow(self.sd_y,2))
    ...
    def update_r(self,Gau1,Gau2):
        ...
        self.r=random.gammavariate(new_a,new_b)
    def update_omega(self,Gau1,Gau2):
        ...
        self.omega=random.gammavariate(new_a,new_b)
...
class Gau(object):
    def __init__(self,Data,hyperparameter):
        ...
        self.sigma=random.gammavariate(hyperparameter.beta,1/hyperparameter.omega)
    ...
    def update_sigma(self,latent,group,beta,omega):
        ...
        self.sigma=random.gammavariate(new_a,new_b)
...
print(data.mean,data.sd)
hyperparameter=Hyperparameter(data.mean,data.sd,k)
print(hyperparameter.lambd,hyperparameter.r,hyperparameter.beta,hyperparameter.omega)
