...
class Gau(object):
    def __init__(self,Data,hyperparameter,k):
        ...
        self.gau_mixture=[]
        for i in range(k):
            mu=random.gauss(hyperparameter.lambd,1/hyperparameter.r)
    ...
    def update_mu(self,latent,lambd,r):
        ...
        for i in range(len(self.gau_mixture)):
            ...
            new_sd=1/(n*self.gau_mixture[i][1]+r)
            self.gau_mixture[i][0]=random.gauss(new_mean,new_sd)
