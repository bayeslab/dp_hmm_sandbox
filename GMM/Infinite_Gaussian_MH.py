...
def alpha_density_ratio(new_alpha,alpha,k,n):
    log_ratio = (k-1.5)*(math.log(new_alpha)-math.log(alpha))-0.5*(1./alpha-1./new_alpha)+math.lgamma(new_alpha)-math.lgamma(alpha)-math.lgamma(n+new_alpha)+math.lgamma(n+alpha)
...
class Infinite_Gaussian(object):
    ...
    def update_alpha(self):
        ...
        r = min(1, alpha_density_ratio(y, self.alpha,self.k,self.n))
    ...
    def update_state(self):
        ...
        for i in range(self.n):
            ...
            new_mu=random.gauss(self.ori_lambd, pow(1/self.ori_r,0.5))
            new_s=gamma(self.ori_beta,1/self.ori_omega)
...
print("alpha rejection rate: ", Data1.reject_alpha/500)
print("beta rejection rate: ", Data1.reject_beta/500)
